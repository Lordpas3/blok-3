...
@section ('content')
    ...
    <div class="motivatie">
        ...
        <p>Je bent in <b>redelijke mate intrinsiek gemotiveerd</b> en in <b>redelijke mate extrinsiek gemotiveerd.</b>
            Dat
            je redelijk
            intrinsiek gemotiveerd bent betekent dat je het <b>best leuk vindt om te studeren. Maar héél leuk vind je
                het
                nou ook weer niet.</b> Dat je in redelijke mate extrinsiek gemotiveerd bent wil zeggen dat je er ook <b>rekening
                mee houdt wat je met je studie kunt bereiken:</b> een diploma, geld, status of de erkenning van de
            mensen
            waar
    ...
    <div class="motivatie">
        ...
        <p>Ik heb feedback gekregen van mijn vriendin en zij vindt dat mijn motivatie goed is, maar dat ik wel beter
            kan. Ik ben af en toe een beetje lui en doe niet 100% mijn best, maar ik zou dat best kunnen als ik er wat
            meer
            moeite in zou steken. Ik werk hard op school en maak alles altijd thuis af, waardoor ik ‘s avonds vrije tijd
            overhoud om
            te relaxen.
        </p>
    </div>
    ...
    <div class="bronnen">
        <h2>Bronnenlijst</h2>
        <h3>Theorie</h3>
        <p>Applinet B.V. (z.d.). Wat is motivatie? - cursus Medewerkers motiveren. Geraadpleegd op 30 september 2019,
            van
            https://www.leren.nl/cursus/management/motiveren/wat-is-motivatie.html
        </p>
        <p>Control & Motivate. (z.d.). Ken jij de 4 typen motivatie? | Control & Motivate. Geraadpleegd op 30 september
            2019, van https://controlandmotivate.nl/4-typen-motivatie/
        </p>
        <p>Wat zijn de vier typen motivatie? - Leerling 2020. (z.d.). Geraadpleegd op 30 september 2019, van
            https://leerling2020.nl/faq-onderzoek/wat-zijn-de-vier-typen-motivatie/
        </p>
        <p>Pink, D. (2009 juli). The puzzle of motivation. Geraadpleegd op 30 september 2019, van
            https://www.ted.com/talks/dan_pink_on_motivation
        </p>
        <p>Corporate story. (z.d.). Geraadpleegd op 31 september 2019, van https://asolution.nl/corporate-story/
        </p>
        <p>van Oosterhout, M. (2004). Prestatiemotivatie ontwikkelen. Geraadpleegd op 30 september 2019, van
            http://www.carrieretijger.nl/functioneren/management/prestatiemotivatie
        </p>
        <h3>Prestatiemotivatie</h3>
        <p>123test. (z.d.). Prestatiemotivatie | test je intrinsieke en extrinsieke motivatie | 123test.nl. Geraadpleegd
            op
            1 oktober 2019, van https://www.123test.nl/prestatiemotivatie/
        </p>
        <h3>Carrièreankers</h3>
        <p>123test. (z.d.-a). Carrièreankers | test je drijfveren (Schein) | 123test.nl. Geraadpleegd op 1 oktober 2019,
            van
            https://www.123test.nl/schein/
        </p>
        <p></p>
