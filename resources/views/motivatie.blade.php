...
<div class="motivatie">
    ...
    <p>Je bent in <b>redelijke mate intrinsiek gemotiveerd</b> en in <b>redelijke mate extrinsiek gemotiveerd.</b> Dat
        je redelijk
        intrinsiek gemotiveerd bent betekent dat je het <b>best leuk vindt om te studeren. Maar héél leuk vind je het
            nou ook weer niet.</b> Dat je in redelijke mate extrinsiek gemotiveerd bent wil zeggen dat je er ook <b>rekening
            mee houdt wat je met je studie kunt bereiken:</b> een diploma, geld, status of de erkenning van de mensen
        waar
...
<div class="bronnen">
    <h2>Bronnenlijst</h2>
    <h3>Theorie</h3>
    <p>Applinet B.V. (z.d.). Wat is motivatie? - cursus Medewerkers motiveren. Geraadpleegd op 30 september 2019, van
    ...
    <p>123test. (z.d.). Prestatiemotivatie | test je intrinsieke en extrinsieke motivatie | 123test.nl. Geraadpleegd op
        1 oktober 2019, van https://www.123test.nl/prestatiemotivatie/
    </p>
    <h3>Carrièreankers</h3>
    <p>123test. (z.d.-a). Carrièreankers | test je drijfveren (Schein) | 123test.nl. Geraadpleegd op 1 oktober 2019, van
