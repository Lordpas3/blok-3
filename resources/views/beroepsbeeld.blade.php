...
@section ('content')
    ...
    <p style="margin-left : 50%">Er zijn een hoop verschillende functies binnen de bedrijven, meer dan alleen
        ...
        software testers zijn ook niet weg te denken, net zoals <b>data scientists</b>. Er zijn dus talloze
        verschillende
    ...
    <p style="margin-right: 45%;">Nadat we bij de verschillende bedrijven zijn geweest hebben we de cultuur een beetje
        ...
        wilt, wat ik compleet niet had verwacht. Ik neem aan dat dit niet overal zo is, maar <b>ik vind het wel erg
            prettig
            om te weten dat er genoeg bedrijven zijn waar je gewoon casual kan werken en niet super professioneel hoeft
            te
            zijn.</b></p>
    <img width="40%" height="40%" class="beroepsPlaatjes" style='margin: 6% 0.5% 0.5% 0.5%;' src="/downloads/foto7.jpg"
         alt="Plaatje">
    <img width="40%" height="40%" class="beroepsPlaatjes" style='margin: 0.5%;' src="/downloads/foto4.jpg"
         alt="Plaatje">
    <img width="40%" height="40%" class="beroepsPlaatjes" style='margin: 0.5%;' src="/downloads/foto5.jpg"
         alt="Plaatje">
    <img width="40%" height="40%" class="beroepsPlaatjes" style='margin: 0.5%;' src="/downloads/foto6.jpg"
         alt="Plaatje">
